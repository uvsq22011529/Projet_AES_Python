...
def SubWord(tab):
    ...
    return np.array([format(Sbox[int(elem[0], 16)*16 + int(elem[1], 16)]) for elem in tab])
...
def MixColumns(etat):
    ...
    for i in range(4):
        ...
        etat_change[0, i] = format(multiplication_by_2[int(un0[0], 16)*16 + int(un0[1], 16)]^multiplication_by_3[int(un1[0], 16)*16 + int(un1[1], 16)]^int(un2, 16)^int(un3, 16))
        etat_change[1, i] = format(multiplication_by_2[int(un1[0], 16)*16 + int(un1[1], 16)]^multiplication_by_3[int(un2[0], 16)*16 + int(un2[1], 16)]^int(un0, 16)^int(un3, 16))
        etat_change[2, i] = format(multiplication_by_2[int(un2[0], 16)*16 + int(un2[1], 16)]^multiplication_by_3[int(un3[0], 16)*16 + int(un3[1], 16)]^int(un0, 16)^int(un1, 16))
        etat_change[3, i] = format(multiplication_by_2[int(un3[0], 16)*16 + int(un3[1], 16)]^multiplication_by_3[int(un0[0], 16)*16 + int(un0[1], 16)]^int(un2, 16)^int(un1, 16))
    return etat_change
...
print(encrypt('theblockbreakers', cle))